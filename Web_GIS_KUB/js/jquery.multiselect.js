            ...
            optionsWrap.on('click', '.ms-selectall', function (event) {
                ...
                if ($(this).hasClass('global')) {
                    ...
                    if (optgroup.find('li:not(.selected, .ms-hidden)').length) {
                        ...
                        var addDateArr = [];
                        var needToAdd = true;
                        optgroup.find('li:not(.selected, .ms-hidden) input[type="checkbox"]').each(function (key, value) {
                            addDateArr.push(value.value);
                        })
                        // my code
                    ...
                    // deselect everything
                        ...
                        // my code
                        optgroup.find('li.selected input[type="checkbox"]:not(:disabled)').each(function (key, value) {
                            removeDate(value.value)
                        });
                        needToAdd = false;
                        //my code
                ...
                // my code
                if (needToAdd) {
                    $(addDateArr).each(function (key, date) {
                        let position;
                        $('#lstDates').find('option:selected').each(function (index, value) {
                            if (date == $(value).attr("value")) {
                                //console.log(index);
                                position = index;
                            }
                        })
                        addDate(date, position);
                    })
        ...
        _updateSelectAllText: function (visibleOnly) {
            ...
            optionsWrap.find('.ms-selectall').each(function () {
                ...
                $(this).text(
                    ...
                    unselected.length ? instance.options.texts="Выбрать все" : instance.options.texts = "Сбросить все"
                );
            });
        },
